...
SIZE_INDEX = [0]
min_max = [100]
filename_out = "gen_batches_outputs_instrumentations.txt"
filename_res = "gen_batches_results_instrumentations.txt"
...
def main():
    ...
    for inp in interesting_inpts:
        ...
        stdout_ = sys.stdout
        sys.stdout = f
        tracer.runfunc(generate_batches.generate_batches,new_inp)
        f.write("***\n")
        sys.stdout = stdout_
        time.sleep(1)
    f.close()
